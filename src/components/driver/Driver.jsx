...
//                             <button className='hireRequestButton' onClick={handleRequestClick}>Request</button>
//                             <div className='driver-content-top-right-bot'>
...
export const Driver = () => {
    ...
    const handleRequestClick = (driverId) => {
        navigate(`/hire/${driverId}`); // Redirect to the request page with driverId
    };
            ...
            <div className='driver-content'>
                {drivers.map(driver => (
                    <div className='driver-content-top' key={driver.id}>
                        ...
                        <div className='driver-content-top-right'>
                            <button className='hireRequestButton' onClick={() => handleRequestClick(driver.id)}>Request</button>
                            <div className='driver-content-top-right-bot'>
                                {driver.date} | {driver.time} | {driver.price} LKR per person
                            </div>
                        </div>
